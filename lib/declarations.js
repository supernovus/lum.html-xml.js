 ...
 * 
 * @module @lumjs/html-xml/declarations
 */
 ...
 * [XHTML 1.0]{@link module:@lumjs/html-xml/declarations.XHTML_10_TAG} 
 * attributes added.
 * 
 * @param {string} doc - The full document we are updating.
 * @returns {string} The `doc` with the replacement done.
...
/**
 * Replace the `<html>` opening tag with a version that has the recommended
 * [XHTML 1.1]{@link module:@lumjs/html-xml/declarations.XHTML_11_TAG} 
 * attributes added.
 * 
 * @param {string} doc - The full document we are updating.
 * @returns {string} The `doc` with the replacement done.
